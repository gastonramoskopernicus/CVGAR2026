...
4. **Diseño Visual:** La vista adopta un concepto tipo "sistema planetario". Cada aplicación privada debe representarse como un planeta u órbita (no infantil, elegante).
